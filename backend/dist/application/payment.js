...
exports.handleWebhook = exports.retrieveSessionStatus = exports.createCheckoutSession = void 0;
...
const retrieveSessionStatus = async (req, res) => {
    try {
        ...
        if (checkoutSession.payment_status === "paid" && booking.paymentStatus !== "PAID") {
            ...
            await Booking_1.default.findByIdAndUpdate(booking._id, { paymentStatus: "PAID" });
...
async function fulfillCheckout(sessionId) {
    ...
    try {
        ...
        console.log("Session details:", util_1.default.inspect(checkoutSession, false, null, true));
        const booking = await Booking_1.default.findById(checkoutSession.metadata?.bookingId);
        if (!booking) {
